...
public class Project
{
    public class Project {
        ...
        public Project(String id, String description,String title ,int day ,int month, int year, String status)
        {
            this.id = id;
        ...
        public Project(String title, String description, int day, int month, int year, String role)
        {
            this.title = title;
            this.description = description;
            date = new MyDate(day, month, year);
